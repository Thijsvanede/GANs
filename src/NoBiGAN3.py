...
if __name__ == '__main__':
    ...
    # Create NoBiGAN3
    gan = NoBiGAN3(dim_input_g=2, dim_input_d=(28, 28))
    ...
    # Save GAN
    gan.save('../saved/NoBiGAN3_g.h5', '../saved/NoBiGAN3_d.h5', '../saved/NoBiGAN3_c.h5')
    # Load GAN
    #gan.load('../saved/NoBiGAN3_g.h5', '../saved/NoBiGAN3_d.h5', '../saved/NoBiGAN3_c.h5')
